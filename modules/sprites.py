...
#importando las bibliotecas de pygame y random
import pygame
import random
...
#Creando una clase para representar los obstaculos de uamito
class Asteroid(pygame.sprite.Sprite):
    def __init__(self, cfg):
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.image.load(cfg.IMAGEPATHS['unam']).convert_alpha()
